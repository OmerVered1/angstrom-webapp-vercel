...
export const en: Translations = {
  ...
  analysis: {
    ...
    setupSaveFailed: 'Failed to save setup',
    setupDeleteFailed: 'Failed to delete setup',
    manageSetups: 'Manage setups',
    noSetupsYet: 'No saved setups yet.',
    waveType: 'Wave type:',
    waveSine: 'Sine',
    waveSquare: 'Square',
    periodInput: 'Period (s)',
    periodAutoDetected: 'Auto-detected from source edges. Edit if needed.',
    ...
    auto: 'Auto',
    manual: 'Manual',
    modeAutoPeaks: 'Auto (peaks)',
    modeAutoHybrid: 'Auto (peaks + FFT)',
    modeAutoFFT: 'Auto (FFT)',
    fftPeriodOverride: 'FFT period override (s)',
    fftPeriodHint: 'Leave blank to auto-detect via FFT',
    ...
    smoothToSine: 'Smooth to single sine',
    smoothToSineHint: 'fit A·sin(ωt+φ) to source & response, then analyze the fitted sines',
    errSmoothFailed: 'Could not fit a sine to the selected region — widen it or check the signal.',
    duplicateTitle: 'Similar analysis already saved',
    duplicateMessage: 'An existing analysis matches this one (same sample, date, method, and very close period & A₁):',
    replaceExisting: 'Replace it',
    saveAsNew: 'Save as new',
    manualStepRegion: 'Choose region',
    manualStepPeaks: 'Choose peaks',
    nextChoosePeaks: 'Next: choose peaks →',
    ...
    periodTResp: 'Response Period T',
    frequencyFSrc: 'Source Frequency f',
    frequencyFResp: 'Response Frequency f',
  ...
  history: {
    ...
    periodTSrc: 'Source Period T',
    periodTResp: 'Response Period T',
    frequencySrc: 'Source Frequency',
    frequencyResp: 'Response Frequency',
    rawDt: 'Raw \u0394t',
  ...
  statistics: {
    ...
    analysisModeFilter: 'Analysis Mode',
    ...
    periodSourceSrc: 'Source',
    periodSourceResp: 'Response',
    periodSourceHint: 'Applies to Period / Frequency axes and Period-based groupings',
  },
